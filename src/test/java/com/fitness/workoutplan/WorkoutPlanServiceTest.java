package com.fitness.workoutplan;
...
import com.fitness.model.DifficultyLevel;
...
public class WorkoutPlanServiceTest {
	    ...
	    void testCreateWorkoutPlan_Success() {
	        ...
	        mockPlan.setDifficulty(DifficultyLevel.INTERMEDIATE);
	        ...
	        assertEquals(DifficultyLevel.INTERMEDIATE, createdPlan.getDifficulty());
