...
import com.fitness.service.ActivitylogService;
...
public class ActivitylogController {
    ...
    public ResponseEntity<ActivityLog> createActivityLog(@PathVariable Long userId, @PathVariable Long workoutPlanId, @Valid @RequestBody ActivityLog activityLog) {
