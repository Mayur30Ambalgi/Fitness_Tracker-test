...
public class WorkoutPlanController {
	...
	public ResponseEntity<WorkoutPlan> createWorkoutPlan(@PathVariable Long userId, @Valid @RequestBody WorkoutPlan workoutPlan) {
        return ResponseEntity.status(HttpStatus.CREATED).body(workoutPlanService.createWorkoutPlan(workoutPlan, userId));
    }
